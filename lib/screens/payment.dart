...
import 'package:lord_bank/components/customDialog.dart';
import 'package:lord_bank/database/database_helper.dart';
import 'package:lord_bank/models/transactionData.dart';
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (transferAmount == null || transferAmount==0) {
                            ...
                            await _dbHelper.insertTransactionHistory(_transactionDetails);
                            ...
                            showDialog(
                                ...
                                builder: (context) {
                                  return CustomDialog(
                                    onPressed: () {
                                      Navigator.popUntil(context, ModalRoute.withName('/customer_list'));
                                    },
